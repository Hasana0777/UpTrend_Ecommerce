...
<div className="pd-right-descpt">
   A lightweighted material, usually knitted, pullover shirt, close-fitting and comfortable to wear
</div>
...
<p className='pd-right-category'><span>Category: </span>Women, T-shirt,tops</p>


<p className='pd-right-category'><span>Tags: </span>Modern, Latest,tops</p>
    </div>
